...
***Investigating Complex Inheritance in Congenital Heart Disease***

Congenital heart disease affects approximately 1% of live births and remains the leading cause of mortality from birth defects. Despite extensive research efforts, the etiology of ~55% of cases remains unexplained by environmental triggers, chromosomal abnormalities, or monogenic factors. Increasing evidence suggests that simple genetic models do not fully account for all cases with congenital heart disease, necessitating more nuanced approaches and advanced genomic technologies. Our work focuses on leveraging short-read and long-read sequencing technologies, combined with zebrafish functional experiments, to investigate complex genetic variations and deviations from Mendelian inheritance patterns that underlie congenital heart disease.

***Human Genetics and Molecular Mechanisms of Human Neurological Diseases***

In collaboration with Drs. [Kristopher Kahle](https://www.massgeneral.org/doctors/22473/kristopher-kahle), [Kristen Kroll](https://sites.wustl.edu/krolllab/), [Engin Deniz](https://medicine.yale.edu/profile/engin-deniz/), and the [WashU Undiagnosed Diseases Network](https://undiagnoseddiseases.wustl.edu/), we are focusing on studying the genetic underpinnings of rare Mendelian forms of human neurological diseases, using whole-genome sequencing, quantitative phenotyping, transcriptomic profiling, massively parallel reporter assays, and in vitro/in vivo models.
